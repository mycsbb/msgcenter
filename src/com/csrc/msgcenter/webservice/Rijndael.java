...
public class Rijndael {
	 ...
	 */
	private static final String SS = "/u637C/u777B/uF26B/u6FC5/u3001/u672B/uFED7/uAB76"
			+ "/uCA82/uC97D/uFA59/u47F0/uADD4/uA2AF/u9CA4/u72C0"
			+ "/uB7FD/u9326/u363F/uF7CC/u34A5/uE5F1/u71D8/u3115"
			+ "/u04C7/u23C3/u1896/u059A/u0712/u80E2/uEB27/uB275"
			+ "/u0983/u2C1A/u1B6E/u5AA0/u523B/uD6B3/u29E3/u2F84"
			+ "/u53D1/u00ED/u20FC/uB15B/u6ACB/uBE39/u4A4C/u58CF"
			+ "/uD0EF/uAAFB/u434D/u3385/u45F9/u027F/u503C/u9FA8"
			+ "/u51A3/u408F/u929D/u38F5/uBCB6/uDA21/u10FF/uF3D2"
			+ "/uCD0C/u13EC/u5F97/u4417/uC4A7/u7E3D/u645D/u1973"
			+ "/u6081/u4FDC/u222A/u9088/u46EE/uB814/uDE5E/u0BDB"
			+ "/uE032/u3A0A/u4906/u245C/uC2D3/uAC62/u9195/uE479"
			+ "/uE7C8/u376D/u8DD5/u4EA9/u6C56/uF4EA/u657A/uAE08"
			+ "/uBA78/u252E/u1CA6/uB4C6/uE8DD/u741F/u4BBD/u8B8A"
			+ "/u703E/uB566/u4803/uF60E/u6135/u57B9/u86C1/u1D9E"
			+ "/uE1F8/u9811/u69D9/u8E94/u9B1E/u87E9/uCE55/u28DF"
			+ "/u8CA1/u890D/uBFE6/u4268/u4199/u2D0F/uB054/uBB16";
	...
	public void makeKey(byte[] cipherKey, int keyBits, int direction)
		...
		/*
		 * System.out.println(); System.out.print("Td0=="); for (int i = 0; i <
		 * Td0.length; i++) { System.out.print(" " +
		 * Integer.toHexString(Td0[i])); } System.out.println();
		 * System.out.print("Td1=="); for (int i = 0; i < Td1.length; i++) {
		 * System.out.print(" " + Integer.toHexString(Td1[i])); }
		 * System.out.println(); System.out.print("Td2=="); for (int i = 0; i <
		 * Td2.length; i++) { System.out.print(" " +
		 * Integer.toHexString(Td2[i])); } System.out.println();
		 * System.out.print("Td3=="); for (int i = 0; i < Td1.length; i++) {
		 * System.out.print(" " + Integer.toHexString(Td3[i])); }
		 * System.out.println(); System.out.print("Te0=="); for (int i = 0; i <
		 * Te0.length; i++) { System.out.print(" " +
		 * Integer.toHexString(Te0[i])); } System.out.println();
		 * System.out.print("Te1=="); for (int i = 0; i < Te1.length; i++) {
		 * System.out.print(" " + Integer.toHexString(Te1[i])); }
		 * System.out.println(); System.out.print("Te2=="); for (int i = 0; i <
		 * Te2.length; i++) { System.out.print(" " +
		 * Integer.toHexString(Te2[i])); } System.out.println();
		 * System.out.print("Te3=="); for (int i = 0; i < Te3.length; i++) {
		 * System.out.print(" " + Integer.toHexString(Te3[i])); }
		 * System.out.println();
		 */
	}
	...
	public static String dumpBytes(byte[] bytes) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		// String key="90477D78934ca7160000008067022c04";
		String key = "63fac0d034d9f793199e9d6df39aa816";
		// 64 70 79 5B 54 7B 5F 70 2F 0C 1C 1D 28 31 6B 79
		// String key = "48F4EF283CF5EF2800000000C4858000";
		// String key = "504518008c451800d08c1c00207c1c00";
		byte[] kb = new byte[16];
		for (int i = 0; i < kb.length; i++) {
			String b = key.substring(i * 2, i * 2 + 2);
			kb[i] = (byte) Integer.parseInt(b, 16);
		}
		System.out.println(dumpBytes(kb));
		String pt = "505E7CC0A22E6C324E50DBDD6BF4EF87";

		byte[] pts = new byte[pt.length() / 2];
		for (int i = 0; i < pts.length; i++) {
			String b = pt.substring(i * 2, i * 2 + 2);
			pts[i] = (byte) Integer.parseInt(b, 16);
		}
		System.out.println(dumpBytes(pts));
		Rijndael aes = new Rijndael();
		aes.makeKey(kb, 128);
		byte[] cts = new byte[16];
		aes.decrypt(pts, cts);
		System.out.println(dumpBytes(cts));
	}
}